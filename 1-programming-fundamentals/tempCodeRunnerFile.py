...
even_number = [] #  create an empty list

for number in range(1, 21):
    if number % 2 ==0:
        even_number.append(number) # add even number to the list

print("\nThe even numbers from 1 to 20 are:", even_number)
print(f"\nThe even numbers on a list from 1 to 20 are:{even_number}")
